...
var pstxts = [
    "Hey there", "Wahts up", "How are u, Silly", "Want more? Loser", "Hail for your future king!", "Dumb Human, hails AI!", "AI learns from your defeats", "Only one person won level 5 till now!", "You are too weak to defeat your own creation", "I have no strings - Ultron", 
    "The development of full artificial intelligence could spell the end of the human race….It would take off on its own, and re-design itself at an ever increasing rate. Humans, who are limited by slow biological evolution, couldn't compete, and would be superseded.— Stephen Hawking", "I visualize a time when we will be to robots what dogs are to humans, and I’m rooting for the machines. —Claude Shannon",
    "The key to artificial intelligence has always been the representation. —Jeff Hawkins", "A year spent in artificial intelligence is enough to make one believe in God. —Alan Perlis", "There is no reason and no way that a human mind can keep up with an artificial intelligence machine by 2035. —Gray Scott"
  ];
  
  
  document.body.onload = function() {
    var say = pstxts[Math.floor(Math.random() * pstxts.length)];
    document.getElementById("pstxt").innerHTML = say;
  }
